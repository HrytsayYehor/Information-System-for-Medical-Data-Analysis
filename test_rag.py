...
def run_interface():
    ...
    query = st.text_input(
        "Введіть запит:",
        help="Введіть текст запиту для пошуку відповідних документів."
    )
    ...
    # Додано кнопку з доступним текстом і описом
    st.button("Оновити результати", help="Оновлює дані та результати пошуку")
