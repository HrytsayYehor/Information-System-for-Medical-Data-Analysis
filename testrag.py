...
from memory_profiler import profile  # Імпортуємо профілювання пам'яті
import cProfile  # Для профілювання CPU
...
if __name__ == "__main__":
    # Для запуску CPU профілювання додамо:
    ...
    profiler.disable()
    profiler.print_stats(sort="time")  # Виводимо статистику за часом виконання
